...
async function seed() {
  ...
  // ───── Link workers to planillas ─────
  const planillasLinks = [
    { trabajadorId: workerIds[0], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[1], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[2], planillaId: ids.planillaAdministrativa },
    { trabajadorId: workerIds[3], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[4], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[5], planillaId: ids.planillaMensual },
    { trabajadorId: workerIds[6], planillaId: ids.planillaVehicular },
    { trabajadorId: workerIds[7], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[8], planillaId: ids.planillaTemporal },
    { trabajadorId: workerIds[9], planillaId: ids.planillaMensual },
    { trabajadorId: workerIds[10], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[11], planillaId: ids.planillaAdministrativa },
    { trabajadorId: workerIds[12], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[13], planillaId: ids.planillaTemporal },
    { trabajadorId: workerIds[14], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[15], planillaId: ids.planillaMensual },
    { trabajadorId: workerIds[16], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[17], planillaId: ids.planillaVehicular },
    { trabajadorId: workerIds[18], planillaId: ids.planillaAdministrativa },
    { trabajadorId: workerIds[19], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[20], planillaId: ids.planillaMensual },
    { trabajadorId: workerIds[21], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[22], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[23], planillaId: ids.planillaAdministrativa },
    { trabajadorId: workerIds[24], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[25], planillaId: ids.planillaMensual },
    { trabajadorId: workerIds[26], planillaId: ids.planillaTemporal },
    { trabajadorId: workerIds[27], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[28], planillaId: ids.planillaAdministrativa },
    { trabajadorId: workerIds[29], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[30], planillaId: ids.planillaMensual },
    { trabajadorId: workerIds[31], planillaId: ids.planillaQuincenal },
    { trabajadorId: workerIds[32], planillaId: ids.planillaTemporal },
    { trabajadorId: workerIds[33], planillaId: ids.planillaAdministrativa },
    { trabajadorId: workerIds[34], planillaId: ids.planillaQuincenal },
  ];
